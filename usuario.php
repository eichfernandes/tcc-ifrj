            ...
            <div class="content" style="width: 900px;"><!-- Define o que estará no conteúdo central -->
                <div class="block"><!-- Cada div block é um bloco de conteúdo -->
                    <div style="width: 700px; margin: 0px auto 20px; text-align: center">
                        <?php 
                        $resultseg = mysqli_query($mysqli, "select (select count(id_usuario) from amizades where id_usuario=$id)"
                                . " as 'Seguindo', (select count(id_amigo) from amizades where id_amigo=$id) as 'Seguidores'");
                    ...
                    <div class="blockin" style="padding-bottom: 16px; text-align: center; width: 370px; margin: auto;">
